...
public class LoadBalancedScanRecordReadRequest extends LoadBalancedAbstractRecordReadRequest {

  public LoadBalancedScanRecordReadRequest(LoadBalancedAbstractReadManager readMgr, LoadBalancedDynamoDBRecordReaderContext context,
  ...
  protected LoadBalancedAbstractRecordReadRequest buildNextReadRequest(PageResults<Map<String,
    ...
    return new LoadBalancedScanRecordReadRequest(readMgr, context, segment, pageResults.lastEvaluatedKey);
  }
