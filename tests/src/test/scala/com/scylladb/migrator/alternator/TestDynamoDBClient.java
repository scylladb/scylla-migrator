...
public class TestDynamoDBClient {
  ...
  private final TestDynamoDBClient dynamoDB;
  ...
  public TestDynamoDBClient() {
    this((DynamoDbClient) null, null);
  }

  public TestDynamoDBClient(DynamoDbClient amazonDynamoDBClient, Configuration conf) {
  ...
  public TestDynamoDBClient(Configuration conf) {
    this(conf, null);
  }

  public TestDynamoDBClient(Configuration conf, String region) {
