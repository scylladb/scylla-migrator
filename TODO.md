...
- [x] Split scylla and alternator integration tests into parallel CI jobs
...
- [x] Start Docker services in parallel with build in CI
...
- [x] Cache the Spark Docker image in CI
